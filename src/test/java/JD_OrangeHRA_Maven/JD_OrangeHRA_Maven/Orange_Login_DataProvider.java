...
//This class is for verify the data. Eg:check whether these user have access to the system or not.
public class Orange_Login_DataProvider extends OrangeHraTestData{
