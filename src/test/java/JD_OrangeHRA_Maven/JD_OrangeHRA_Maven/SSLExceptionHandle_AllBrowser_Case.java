...
public class SSLExceptionHandle_AllBrowser_Case {
	 ...
	 * //options.setHeadless(true); options.merge(capabilities); //this will merge
	 * the capabilities to the ChromeOptions // setting system property for Firefox
